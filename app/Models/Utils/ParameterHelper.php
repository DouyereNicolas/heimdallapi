...
//    }
    ...
    {
        return ParameterHelper::testInt($controller, $request, $response, 'materialData_materialId', $required);
    }

    public static function testDataKey(Controller $controller, Request $request, Response $response, string $var,  bool $required): ?string
    {
        return ParameterHelper::testString($controller, $request, $response, $var, $required);
    }

    public static function testDataColumn(Controller $controller, Request $request, Response $response, string $var, bool $required): ?string
    {
        return ParameterHelper::testString($controller, $request, $response, $var, $required);
    }

    public static function testMaterialRef(Controller $controller, Request $request, Response $response, bool $required): ?string
    {
        return ParameterHelper::testString($controller, $request, $response, 'material_ref', $required);
    }

    public static function testDataSiteId(Controller $controller, Request $request, Response $response, bool $required): ?int
    {
        return ParameterHelper::testInt($controller, $request, $response, 'siteData_siteId', $required);
    }
    public static function testDataUserId(Controller $controller, Request $request, Response $response, bool $required): ?int
    {
        return ParameterHelper::testInt($controller, $request, $response, 'userData_userId', $required);
    }

    public static function testTicketRef(Controller $controller, Request $request, Response $response, bool $required): ?string
    {
        return ParameterHelper::testString($controller, $request, $response, 'ticket_ref', $required);
    }

    public static function testDataTicketId(Controller $controller, Request $request, Response $response, bool $required): ?int
    {
        return ParameterHelper::testInt($controller, $request, $response, 'problemData_problemId', $required);
    }
}
